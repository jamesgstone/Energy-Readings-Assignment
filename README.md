...
# Scaling Logic:
 The ScaledObject is configured to trigger scaling when the pending message count in the energy_readings stream exceeds 5. It is configured with a minReplicaCount of 1 and a maxReplicaCount of 5.


# Environment Variables:
Configuration (Host, Port, Stream names) is injected via Kubernetes env vars, allowing for easy environment-specific overrides in the values.yaml file.
